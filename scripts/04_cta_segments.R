...
# at time 2
0.194895 + -0.012844*(-1.5077466) + 0.010605*((-1.5077466)^2) # 0.2383688
# at time 22
0.194895 + -0.012844*(1.5664900) + 0.010605*((1.5664900)^2) # 0.2007985

# percent change = time 22 - time 2 / time 2 * 100
(0.2007985 - 0.2383688)/0.2383688 * 100 #-15.76142 % decrease

# 95% CI, percent change
confint(m_length_quad)
# lower 95% CI
# at time 1
0.178136078 + -0.019559148*(-1.5077466) + 0.004145337*((-1.5077466)^2) # 0.2170499
# at time 21
0.178136078 + -0.019559148*(1.5664900) + 0.004145337*((1.5664900)^2) # 0.1591805
# percent change = time 21 - time 1 / time 1 * 100
(0.1576691 - 0.2170499)/0.2170499 * 100 #-27.35813 % 

# upper 95% CI
# at time 1
0.2116542684 + -0.0061285545*(-1.5077466) + 0.0170650409*((-1.5077466)^2) # 0.2596885
# at time 21
0.2116542684 + -0.0061285545*(1.5664900) + 0.0170650409*((1.5664900)^2) # 0.2439297
# percent change = time 21 - time 1 / time 1 * 100
(0.2439297 - 0.2596885)/0.2596885 * 100 #-5.790733 % 
